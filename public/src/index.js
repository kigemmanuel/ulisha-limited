...
var TeamSection = () => {
  ...
  return /* @__PURE__ */ snapp.create(Section_default, null, /* @__PURE__ */ snapp.create("div", { className: "space-y-6" }, /* @__PURE__ */ snapp.create("div", { className: "text-center" }, /* @__PURE__ */ snapp.create(SectionTitle, null, "Meet Our Team"), /* @__PURE__ */ snapp.create("p", { className: "text-slate-700 mx-auto text-lg" }, "Talented individuals working together to create something amazing")), /* @__PURE__ */ snapp.create("div", { id: "teamDiv" }, /* @__PURE__ */ snapp.create("div", { className: "text-center mx-auto py-12" }, /* @__PURE__ */ snapp.create("p", { className: "text-blue-600 font-semibold text-lg" }, "Fetching team members"), /* @__PURE__ */ snapp.create("p", { className: "text-gray-500 text-sm mt-2" }, "Please wait...")))));
};
